...
MeteorProjectile::MeteorProjectile(int owner, XMFLOAT3 target)
	: Projectile(owner, target + XMFLOAT3(0, 40, 0), XMFLOAT3(0, -1, 0), "F:/Users/Axel/Documents/Visual Studio 11/Projects/Project Warlock/Project Warlock/data/lua/MeteorParticle.lua")
{
