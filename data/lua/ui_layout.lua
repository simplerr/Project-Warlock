TextMenu = {
	menu_bkgd = "data/textures/black_transparent.png";
	item_bkgd = "data/textures/menu_item_bkgd.png";
	font_family = "Arial";
...
ServerMenu = {
	menu_bkgd = "data/textures/white_transparent.png";
	item_bkgd = "data/textures/menu_item_bkgd.png";
...
DefaultButtonData = {
	...
	default_texture = "data/textures/button_bkgd.png";
	disabled_texture = "data/textures/button_bkgd_disabled.png";
	hoover_texture = "data/textures/button_bkgd_hoover.png";
}
