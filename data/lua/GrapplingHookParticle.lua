dofile("data/lua/ParticleFunctions.lua");
...
Projectile = {
	cast_sound = "data/sounds/grappling_attack.wav";
	impact_sound = "data/sounds/grappling_impact.wav";
	speed = 0.28;
	max_distance = 40.0;
	impact_impulse = 0.4;
}
...
ParticleData = {
	texture = "data/textures/star.dds",
	size = 8,
	lifetime = 0.6,
	mass = 0.1,
	speed = 1,
